...
def step_impl(context: MinifiTestContext, processor_name: str):
    controller_service = ControllerService("AwsCredentialServiceRs", "my_aws_controller_service")
    controller_service.add_property('Access Key', 'test_access_key')
    controller_service.add_property('Secret Key', 'test_secret')
    ...
    processor.add_property('AWS Credentials Provider service', "my_aws_controller_service")
