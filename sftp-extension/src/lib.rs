...
pub extern "C" fn InitExtension(
    ...
    use minifi_native::sys::{MinifiCreateExtension, MinifiExtensionCreateInfo};
    unsafe {
        let mut processor_list = CffiProcessorList::new();
        processor_list.add_processor_definition(Box::new(
            processors::list_sftp::processor_definition::processor_definition(),
        ));
        ...
        let extension_create_info: MinifiExtensionCreateInfo = MinifiExtensionCreateInfo {
            name: "SFTP extension".as_minifi_c_type(),
